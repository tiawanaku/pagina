...
if(isset($_POST['pass'])){
	...
	if($pass!=''){
			...
			if($query){
				echo '<script>alert("Su contraseña se cambio correctamente.");window.location.assing("pin-request.php");</script>';
			}
			else{
		...
		echo '<script>alert("No ingresaste ninguna contrase単a");</script>';
	}
}
?>
<!DOCTYPE html>
