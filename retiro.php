                        ...
                        <div class="content">
                            <div class="btn-controls">
                                <div class="btn-box-row row-fluid">
                                    <a class="btn-box big span4"><i class="fa fa-bank"></i><b> <?php
                                    $i=1;
                                ...
                                ?></b>
                                        <p class="text-muted">
                                            Total para retirar de tu inversion</p>
                                    </a><a class="btn-box big span4"><i class="fa fa-money"></i><b><?php
                                    $i=1;
                                    $query = mysqli_query($con,"select * from plan where userid='$userid'");
                                    if(mysqli_num_rows($query)>0){
                                            while($row=mysqli_fetch_array($query)){
                                                $tre = $row['totalretirobonificacion'];
                                            ?>
                                                <tr>
                                ...
                                ?></b>
                                        <p class="text-muted">
                                            total para retiro de tus bonificaciones</p>
                                    </a><a class="btn-box big span4"><i class="fa fa-money"></i><b><?php
                                    $i=1;
                                    $query = mysqli_query($con,"select * from plan where userid='$userid'");
                                    if(mysqli_num_rows($query)>0){
                                            while($row=mysqli_fetch_array($query)){
                                                $pdi = $row['bonificacion'];
                                            ?>
                                                <tr>
                                    ...
                                    ?>
                                        <tr>
                                            <td colspan="2">no tienes dinero de tus bonificaciones</td>
                                        </tr>
                                    <?php
                                    }
                                ?></b>
                                        <p class="text-muted">
                                            tus bonificaciones por paquetes que vendiste</p>
                                    </a>
                                </div>
                                <!--<div class="btn-box-row row-fluid">
                                    <div class="span8">
